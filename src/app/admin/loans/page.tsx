...
import { adminOverrideLoanStatus, adminBulkUpdateLoanStatus } from "./actions";
...
export default function AdminLoansPage() {
  ...
  async function executeSingleOverride(e: React.FormEvent) {
    ...
    const result = await adminOverrideLoanStatus(targetLoan.id, newStatus, overrideReason);
    setUpdatingId(null);
  ...
  async function executeBulkOverride() {
    ...
    const result = await adminBulkUpdateLoanStatus(selectedLoanIds, bulkActionType);
