...
import { Send, Bell, Users, Building2, CheckCircle2, Megaphone } from "lucide-react";
...
export default function SuperadminNotificationsPage() {
  ...
  async function loadData() {
    ...
    if (notifs) setHistory(notifs as any[]);
    setLoading(false);
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-ink dark:text-white">Manual System Notifications Broadcast</h2>
        <p className="text-sm text-ink-slate">
          Send custom manual notifications to individual users, organization members, or broadcast globally.
        </p>
      </div>
