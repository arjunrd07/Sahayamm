      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200/80 dark:border-surface-border-dark">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-ink dark:text-white tracking-tight">
            Borrower Profile & Financial Vault
          </h1>
          <p className="text-xs sm:text-sm text-ink-slate mt-0.5 font-medium">
            Manage your personal identity, bank payout details, employment credentials, and emergency references.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <span className="text-xs text-ink-slate font-medium flex items-center gap-1">
                  <Building className="h-3.5 w-3.5 text-ink-mist" /> {org?.name ?? "BedRock"}
                </span>
                {profile.kyc_completed && (
                  <>
                    <span>•</span>
                    <span className="text-[11px] font-semibold text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
                      <ShieldCheck className="h-3.5 w-3.5" /> Verified KYC Vault
                    </span>
                  </>
                )}
              </div>
